  ...
  return (
    <div className="min-h-screen bg-background transition-colors">
      ...
      <section className="creative-hero py-20 relative overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="glass-morphism p-8 rounded-3xl backdrop-blur-xl bg-white/30 dark:bg-gray-800/30 border border-white/20 dark:border-gray-700/20">
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1 relative group">
                  <Search
                    className={`absolute top-4 h-5 w-5 text-gray-400 group-focus-within:text-primary transition-colors ${
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[
              ...
              >
                <div
                  className="creative-icon mx-auto mb-3 floating-animation"
        ...
        <div
          className="absolute top-40 right-20 w-16 h-16 bg-gradient-to-r from-pink-400 to-red-500 rounded-full opacity-20 floating-animation"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute bottom-20 left-1/4 w-12 h-12 bg-gradient-to-r from-green-400 to-blue-500 rounded-full opacity-20 floating-animation"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="creative-card group hover:scale-105 transition-all duration-300">
                  <CardContent className="p-8 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      ...
                      <Badge
                        variant="secondary"
                        className="mb-4 bg-gray-100 dark:bg-gray-600 dark:text-gray-200 group-hover:bg-primary/10 transition-colors"
                      >
          ...
          <div className="text-center mt-12">
            <Button
              variant="outline"
              size="lg"
              className="border-2 hover:bg-primary hover:text-white transition-all duration-300 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-primary dark:hover:text-white"
              asChild
            >
              <Link to="/categories">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-16">
            ...
            <Button
              variant="outline"
              className="hover:scale-105 transition-transform dark:border-gray-600 dark:text-gray-300 dark:hover:bg-primary dark:hover:text-white"
              asChild
            >
            ...
            {topCompanies.map((company, index) => (
              ...
              >
                <CardHeader className="pb-4 relative overflow-hidden">
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${company.color} opacity-0 group-hover:opacity-5 transition-opacity duration-300`}
                  ></div>
                  <div className="relative z-10">
                    <div className="flex items-start justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <CardTitle className="text-xl group-hover:text-primary transition-colors text-gray-900 dark:text-white">
                            {company.name}
                          </CardTitle>
          ...
          <div className="glass-morphism p-12 rounded-3xl max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Button
                size="lg"
                variant="secondary"
                className="h-14 px-8 text-lg font-semibold shadow-xl hover:shadow-2xl transition-all transform hover:scale-105"
                asChild
              >
              ...
              <Button
                size="lg"
                variant="outline"
                className="h-14 px-8 text-lg font-semibold bg-transparent border-2 border-white text-white hover:bg-white hover:text-primary transition-all transform hover:scale-105"
                asChild
              >
      ...
      <footer className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>
              &copy; 2024 ReviewHub. All rights reserved. Made with ❤️ in
              Sweden.
            </p>
          </div>
        </div>
