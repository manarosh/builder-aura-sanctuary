...
import { Eye, EyeOff, Star, Mail, Lock, ArrowRight } from "lucide-react";
          ...
          <div className="max-w-md w-full space-y-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-gray-600">
                Sign in to your ReviewHub account
              </p>
            </div>
          ...
          <div className="relative flex flex-col justify-center px-12 text-white">
            <div className="max-w-md">
              ...
              <h3 className="text-3xl font-bold mb-6">
                Join thousands of customers finding trusted businesses
              </h3>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">
                      Access real customer reviews from verified purchases and
                      experiences
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">
                      Help others by sharing your honest feedback about local
                      businesses
                    </p>
                  </div>
                </div>
